...
namespace ContosoAdsWorker
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        private void ProcessQueueMessage(CloudQueueMessage msg)
        {
            ...
            //// Queue message contains OrderId.
            //var adId = int.Parse(msg.AsString);
            //Order ad = db.Orders.Find(adId);
            //if (ad == null)
            //{
            //    throw new Exception(String.Format("OrderId {0} not found, can't create thumbnail", adId.ToString()));
            //}
            ...
            //ad.School = outputBlob.Uri.ToString();
            //db.SaveChanges();
            //Trace.TraceInformation("Updated thumbnail URL in database: {0}", ad.School);
